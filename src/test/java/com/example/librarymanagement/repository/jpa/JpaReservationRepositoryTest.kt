...
class JpaReservationRepositoryTest {
    ...
    fun `should find first by bookId, libraryId is null`() {
        ...
        //WHEN
        val actual = jpaReservationRepository.findFirstByBookIdAndLibraryIdOrLibraryIsNull(id, null)
    ...
    fun `should find first by bookId, libraryId is not null`() {
        ...
        //WHEN
        val actual = jpaReservationRepository.findFirstByBookIdAndLibraryIdOrLibraryIsNull(id, id)
