...
object NatsSubject {
    ...
    object Author {
        ...
        const val FIND_ALL = "$AUTHOR_PREFIX.find_all"
    ...
    object Book {
        ...
        const val FIND_ALL = "$BOOK_PREFIX.find_all"
    ...
    object BookPresence {
        ...
        const val FIND_ALL_BY_LIBRARY_ID = "$BOOK_PRESENCE_REQUEST.find_all_by_library_id"
        const val FIND_ALL_BY_LIBRARY_ID_AND_BOOK_ID = "$BOOK_PRESENCE_REQUEST.find_all_by_library_id_and_book_id"
    ...
    object Journal {
        ...
        const val FIND_ALL_BY_USER_ID = "$REQUEST_PREFIX.find_all_by_user_id"
    }
    ...
    object Library {
        ...
        const val FIND_ALL = "$LIBRARY_PREFIX.find_all"
    ...
    object Publisher {
        ...
        const val FIND_ALL = "$PUBLISHER_PREFIX.find_all"
    ...
    object Reservation {
        ...
        const val FIND_ALL_BY_USER_ID = "$RESERVATION_PREFIX.find_all"
    ...
    object User {
        ...
        const val FIND_ALL = "$USER_PREFIX.find_all"
